...
extension URLRequest {
    ...
    init(httpMethod: HTTPMethod, url: URL) {
        ...
        let userAgent = "AppName SVGOveray; OS \(os); BundleIdentifier \(Bundle.main.bundleIdentifier ?? ""); AppVersion \(appVersion); SystemVersion \(UIDevice.current.systemVersion); DeviceModel \(UIDevice.current.model);"
